// Generated by Avo VERSION 135.19.0. You should never have to make changes to this file.
...
export const EventLocation = {
  ...
  SIZE_PASSPORT_PANEL: 'size-passport_panel',
  PDP: 'pdp',
...
export type EventLocationType = typeof EventLocation;
export type EventLocationValueType = EventLocationType[keyof EventLocationType];
...
function assertPrice(price: number, _label?: string) {
  ...
  messages = messages.concat(AvoAssert.assertMin('5RMsvPEmT', _label ? 'price' + ': ' + _label : 'price', 0.0, price));
  return messages;
}
...
function assertValue(value: number, _label?: string) {
  ...
  messages = messages.concat(AvoAssert.assertMin('Kddfsr3Xx', _label ? 'value' + ': ' + _label : 'value', 0.0, value));
  return messages;
}
  ...
  if (productsCart !== null && productsCart !== undefined && productsCart.forEach) {
    productsCart.forEach(function (value, index) {
      messages = messages.concat(
        AvoAssert.assertObject('NbRKFviNt', 'item at index ' + index + ' in products_cart', value),
      );
...
function assertAmount(amount: number, _label?: string) {
  ...
  messages = messages.concat(
    AvoAssert.assertMin('Vk6lWRKl5', _label ? 'amount' + ': ' + _label : 'amount', 0.0, amount),
  );
  return messages;
}
...
function assertQuantity(quantity: number, _label?: string) {
  let messages: AvoAssertMessage[] = [];
  messages = messages.concat(
    AvoAssert.assertInt('fg1kaNXr_', _label ? 'quantity' + ': ' + _label : 'quantity', quantity),
  );
  messages = messages.concat(
    AvoAssert.assertMin('fg1kaNXr_', _label ? 'quantity' + ': ' + _label : 'quantity', 1, quantity),
  );
  return messages;
}
...
function assertPosition(position: number, _label?: string) {
  let messages: AvoAssertMessage[] = [];
  messages = messages.concat(
    AvoAssert.assertInt('pBPbnpdFj', _label ? 'position' + ': ' + _label : 'position', position),
  );
  messages = messages.concat(
    AvoAssert.assertMin('pBPbnpdFj', _label ? 'position' + ': ' + _label : 'position', 1, position),
  );
  return messages;
}

function assertContextOptional(context: Context | null | undefined, _label?: string) {
  let messages: AvoAssertMessage[] = [];
  if (context !== undefined && context !== null) {
    messages = messages.concat(
      AvoAssert.assertObject('z9n_7LHRQ', _label ? 'context' + ': ' + _label : 'context', context),
    );
  }
  return messages;
}
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3/trigger/hFTLKlhB8
 * 2. When clicking on a product on a PDP in the 'You Might Also Like' carousel.
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3/trigger/uc6_I1PJe
 * 3. When clicking on 'Select Size' in the 'Shop the Look' panel
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3/trigger/2eMjubKrf
 * 4. When clicking on a product on a Journal
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3/trigger/cWUk2zzqA
 * 5. When clicking on a product on the store locator page
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3/trigger/Bpf-If4w-
 * 6. When clicking on a product on a store detail page
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3/trigger/D-ioHoDIM
 * 7. When clicking on 'shop giftcard' button, on the Giftcard landing page
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3/trigger/ecFszVd66
 *
 ...
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kHvR74th3}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'kHvR74th3',
        'ae77c7f447ea523c46a479f36fdc795937156feec41d13a3b7d6b42a75da2ffc',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4a040kO3L/trigger/biZR2zvCbF
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
 ...
 * @param properties.sku: SKU of product, same as product_id
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4a040kO3L}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        '4a040kO3L',
        'b5c36596cd37334b901a2ae6597aa3ad7f31955beff6704601f27230cf82d38a',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * @param properties.sku: SKU of product, same as product_id
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/0mNPEK9jV}
 */
export function productAdded(properties: ProductAddedProperties) {
  ...
  eventPropertiesArray.push({
    id: 'NbRKFviNt',
    name: 'products_cart',
    value: properties.productsCart.map(function (value) {
      return {
        amount: value.amount,
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        '0mNPEK9jV',
        'a7093409b13bec838910af7796379853eb92a2b005678e1bc34cb526a199f3f8',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226/trigger/ilo2Fao9X
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226/trigger/EJGPRxCWM
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226/trigger/8DnMiHdiv
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226/trigger/Y-U_FnScC
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226/trigger/lDHJUY7uw
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226/trigger/hGYSO6MWH
...
title: "Your summary"
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226/trigger/tB6E44bgl
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
 ...
 * @param properties.productsCart: Previously known ssm_products. Should contain an array of all products in the cart. Needs to be cleared on the 'Order Completed' event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/4l0ZskS226}
 */
export function pageLoaded(properties: PageLoadedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        '4l0ZskS226',
        '6f36efe12fa62ce6ceffb0243d18679d34ef212a372290ba8e62634aed101d8e',
        messages.map(m =>
          Object.assign(
            {},
            {
  ...
  if (!__AVO_NOOP__) {
    ...
    // destination Segment
    Segment.logEvent('Page Loaded', (Object as any).assign({}, eventProperties));
    if (Segment.logPage) {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/Xo8CpcqD3k/trigger/dmF0VfnHj
 * 2. Footer - Newsletter
...
Creative:
footer_link
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/Xo8CpcqD3k/trigger/9dwfTm8_b
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
 ...
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/Xo8CpcqD3k}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'Xo8CpcqD3k',
        '79c15bcfe1e4c4c27fd0d42fe4a20d31bdab7bf02aa148f4f0a3b20d9e541f1d',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * @param properties.context: no description
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/lb-B8o9Lf}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'lb-B8o9Lf',
        '52dd5bfba5e0c93de8d6325d75a8e20dd6427980b06fa2e53a004d2614790112',
        messages.map(m =>
          Object.assign(
            {},
            {
...
export interface SelectSizeProperties {
  ...
  eventLocation: EventLocationValueType;
}
/**
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/QZ8ruF0wR/trigger/K_ScJetAs
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
 ...
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/QZ8ruF0wR}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'QZ8ruF0wR',
        '9d0e8af20f7613283254f1b2736335923eb02334030b2d8c25e8b2244bfb4a75',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/FLODrHtrT/trigger/THklYHMK-
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/FLODrHtrT}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'FLODrHtrT',
        'd581ea9539037e29271e3d69809c11ad83e61a5263e3020ac7466af267f3b6e7',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/P8tUoYxJa/trigger/iAlBJNRHt
 * 2. When clicking on the change country button, in the pop up banner
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/P8tUoYxJa/trigger/XocwpVpmE
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/P8tUoYxJa}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'P8tUoYxJa',
        'f78ae1c092b60478bff8f5c5f93507d92b6639f26aa28e46436c18081dda2af9',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/wv224noP0/trigger/dpnHqNIFZ
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/wv224noP0}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'wv224noP0',
        'd6008f6e3a762968a2bd4b006025b42c637a1c9798f81f42db063f4786fb7364',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/u1i6ex4HW/trigger/c4TmbDce1
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/u1i6ex4HW}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'u1i6ex4HW',
        'dcbdd7d5ebf4366a6374fa770dae58a1ba3b30d4487a71bdea1342a15d05eb23',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/vJwt-sKKq/trigger/evtGMEfPQ
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/vJwt-sKKq}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'vJwt-sKKq',
        '1839d4bc624d7dfa6032ebf6ac5112d728b21f2852e382d680b04dd6e4487224',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/Vzc7Bw6Sp/trigger/zaQ-uoQtx
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/Vzc7Bw6Sp}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'Vzc7Bw6Sp',
        'e195fa67be4df150b1c7df0d289ef7ec938b95c5fd11c545ca820a5d5e84deac',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/1Rx8sEaGk/trigger/1_A8oMR5X
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/1Rx8sEaGk}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        '1Rx8sEaGk',
        'bfbd9231bbb32e49ff3002052f54c1f973d5a0cb6b5b16992cee5f1ccdb17857',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/Rh7-qbVFo/trigger/Ici_uz6Uv
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/Rh7-qbVFo}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'Rh7-qbVFo',
        '9e761a6afb57ee62dbe71d0d102707c5b4030619bf0d4c28439633e20bc3a124',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/q034uYqya/trigger/dTt9M_KVq
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
- For PDP size guide button: pdp
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/q034uYqya}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'q034uYqya',
        'fddb3068ff8e209fe11cb647c25b8a1fcbfdfb711f869c29c42631c56a00195d',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/yhrlHOrZQ/trigger/5QvaRyd3N
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
 ...
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/yhrlHOrZQ}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'yhrlHOrZQ',
        '4d649294f72d4dcf66e6b02f626f8a22bf566dcfc2a26e7150f91070c831fb61',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kCtNIDRn2/trigger/dIhRahME5
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
Description is added in the event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/kCtNIDRn2}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'kCtNIDRn2',
        '4299ed4a08ecebd1f279f58a14baebbf8c7ffbf8d34ac813d360eaeacb2f5a42',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/eRtiLrwzB/trigger/r-pdwSlnh
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
Description is added in the event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/eRtiLrwzB}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'eRtiLrwzB',
        'db2fbcfc1d7b4128ab615fa176d12e249678f38981abab80c094073c35b424c9',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/yhBSr917Q/trigger/BXyfxriJU
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
Description is added in the event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/yhBSr917Q}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'yhBSr917Q',
        '3239c810b2bd358a412998ef890c3d6885652b61e98580d94ed4084dd6f46db8',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/KNnHKBbfV/trigger/-TISpFDBA
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
Description is added in the event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/KNnHKBbfV}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'KNnHKBbfV',
        'fba4d3091604e790d127bee58d4fddff090c0c3e231999a0be72833c46f32e53',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/RxyJeDhDH/trigger/18NhXj3B6
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
Description is added in the event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/RxyJeDhDH}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'RxyJeDhDH',
        'c06aa0e4e1a96706350e26f529448576d2c1a293f1cbcc742d5c8ce4c4e377f1',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/EvgoQxQSE/trigger/R0LLZPLto
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
Description is added in the event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/EvgoQxQSE}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'EvgoQxQSE',
        'ebe0a38ea0e2a73592c1d1279b34440a08ecbb97a4eb507ce2a8ca5ff5611183',
        messages.map(m =>
          Object.assign(
            {},
            {
 ...
 * View in Avo: https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/viJG3zwB_/trigger/cAfAKMRSv
 *
 * @param properties the properties associatied with this event
 * @param properties.currency: Currency code, ISO standard in lowercase letters
 * @param properties.country: Local country of website, ISO standard, lowercase
...
Description is added in the event.
 *
 * @see {@link https://www.avo.app/schemas/JmwsgKTQe50MTmUE9FVs/branches/PTbIjpk10/events/viJG3zwB_}
 */
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        'viJG3zwB_',
        '03cef98e93f0fa027abb0dcf6210213f783fb4a40ccb1432748da91768e0edb1',
        messages.map(m =>
          Object.assign(
            {},
            {
...
// AVOMODULEMAP:"Avo"
// AVOEVENTMAP:["productClicked","productViewed","productAdded","pageLoaded","promotionViewed","promotionClicked","selectSize","sizeChanged","changeCountry","changeLanguage","headerAccountClick","headerLogoClick","headerMinicartClick","headerWishlistClick","menuOpened","menuClicked","fabricOptionSelect","fabricOptionConfirm","styleOptionSelect","styleOptionConfirm","summaryEdit","styleOptionChange","styleOptionChangeConfirm","styleOptionChangeCancel"]
