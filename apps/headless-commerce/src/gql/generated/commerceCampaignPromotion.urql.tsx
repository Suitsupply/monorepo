...
export type CommerceCampaignPromotionQueryVariables = Types.Exact<{
  campaignId: Types.Scalars['String'];
  siteInfo: Types.SiteInfo;
}>;


export type CommerceCampaignPromotionQuery = { promotionByCampaignId: Types.Maybe<Pick<Types.Promotion, 'price' | 'discountPrice'>> };


export const CommerceCampaignPromotionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CommerceCampaignPromotion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"siteInfo"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SiteInfo"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"promotionByCampaignId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"campaignId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"campaignId"}}},{"kind":"Argument","name":{"kind":"Name","value":"siteInfo"},"value":{"kind":"Variable","name":{"kind":"Name","value":"siteInfo"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"price"}},{"kind":"Field","name":{"kind":"Name","value":"discountPrice"}}]}}]}}]} as unknown as DocumentNode;

export function useCommerceCampaignPromotionQuery(options: Omit<Urql.UseQueryArgs<CommerceCampaignPromotionQueryVariables>, 'query'>) {
  return Urql.useQuery<CommerceCampaignPromotionQuery, CommerceCampaignPromotionQueryVariables>({ query: CommerceCampaignPromotionDocument, ...options });
};
