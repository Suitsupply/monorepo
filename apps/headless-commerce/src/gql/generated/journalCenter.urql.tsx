...
export type JournalCenterQueryVariables = Types.Exact<{
...
export type JournalCenterQuery = { journalCenterContentBlock: Types.Maybe<(
    Pick<Types.JournalCenterContentBlock, 'title' | 'automationId'>
    & { description: Types.Maybe<(
      Pick<Types.JournalCenterContentBlockDescription, 'json'>
    ...
    )>, mediaContent: Types.Maybe<Pick<Types.MediaWrapperV2, 'cloudinaryDesktopImage' | 'cloudinaryMobileImage' | 'cloudinaryTabletImage' | 'description' | 'lazyloading'>>, button: Types.Maybe<(
