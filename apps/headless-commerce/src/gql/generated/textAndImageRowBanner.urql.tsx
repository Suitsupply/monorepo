...
export type TextAndImageRowBannerQueryQueryVariables = Types.Exact<{
...
export type TextAndImageRowBannerQueryQuery = { textAndImageRowBanner: Types.Maybe<(
    Pick<Types.TextAndImageRowBanner, 'iconName' | 'title'>
    & { description: Types.Maybe<Pick<Types.TextAndImageRowBannerDescription, 'json'>>, mediaContentCollection: Types.Maybe<{ items: Array<Types.Maybe<(
        { __typename: 'DynamicMediaWrapper' }
        & Pick<Types.DynamicMediaWrapper, 'dynamicContent'>
      ) | (
        ...
        & Pick<Types.PinpointOverlayIndicator, 'desktopPinpointPosition' | 'tabletPinpointPosition' | 'mobilePinpointPosition' | 'text' | 'textPosition'>
      )>> }> }
  )> };
...
export function useTextAndImageRowBannerQueryQuery(options: Omit<Urql.UseQueryArgs<TextAndImageRowBannerQueryQueryVariables>, 'query'>) {
  return Urql.useQuery<TextAndImageRowBannerQueryQuery, TextAndImageRowBannerQueryQueryVariables>({ query: TextAndImageRowBannerQueryDocument, ...options });
};
