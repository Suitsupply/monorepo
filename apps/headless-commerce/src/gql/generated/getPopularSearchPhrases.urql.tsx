...
export type PopularSearchQuery = Pick<Types.Query, 'getPopularSearchPhrases'>;
...
export function usePopularSearchQuery(options: Omit<Urql.UseQueryArgs<PopularSearchQueryVariables>, 'query'>) {
  return Urql.useQuery<PopularSearchQuery, PopularSearchQueryVariables>({ query: PopularSearchDocument, ...options });
};
