...
export type TextAndImageColumnBannerQueryVariables = Types.Exact<{
...
export type TextAndImageColumnBannerQuery = { textAndImageColumnBanner: Types.Maybe<(
    Pick<Types.TextAndImageColumnBanner, 'contentOrderDesktop' | 'contentOrderMobile' | 'contentOrderTablet'>
    & { contentCollection: Types.Maybe<{ items: Array<Types.Maybe<(
        { __typename: 'MediaWrapperV2' }
        & Pick<Types.MediaWrapperV2, 'altText' | 'cloudinaryMobileImage' | 'cloudinaryTabletImage' | 'cloudinaryDesktopImage' | 'description' | 'lazyloading'>
        & { sys: Pick<Types.Sys, 'id'> }
      ) | (
        { __typename: 'TextAndButtonBanner' }
        & Pick<Types.TextAndButtonBanner, 'desktopCopyAlignment' | 'mobileCopyAlignment' | 'tabletCopyAlignment'>
        & { sys: Pick<Types.Sys, 'id'>, button: Types.Maybe<(
