...
export type CampaignCollectionBlockContentQueryVariables = Types.Exact<{
...
export type CampaignCollectionBlockContentQuery = { campaignCollectionBlock: Types.Maybe<(
    Pick<Types.CampaignCollectionBlock, 'title'>
    & { sys: Pick<Types.Sys, 'id'>, cta: Types.Maybe<{ link: Types.Maybe<Pick<Types.NavigationLink, 'relativeUrl' | 'referenceId' | 'extraParameters' | 'linkType'>> }>, contentCollection: Types.Maybe<{ items: Array<Types.Maybe<(
        Pick<Types.ImageWithText, 'title' | 'colorPalette'>
        & { image: Types.Maybe<Pick<Types.MediaWrapperV2, 'cloudinaryMobileImage' | 'cloudinaryDesktopImage' | 'cloudinaryTabletImage' | 'altText' | 'lazyloading'>>, link: Types.Maybe<Pick<Types.NavigationLink, 'relativeUrl' | 'referenceId' | 'extraParameters' | 'linkType'>>, subline: Types.Maybe<Pick<Types.ImageWithTextSubline, 'json'>>, promotionEvents: Types.Maybe<Pick<Types.PromotionEvents, 'promotionEventLabel' | 'promotionEventAction' | 'promotionEventCategory' | 'promotionDimension24' | 'promotionPosition' | 'promotionCreative' | 'promotionView' | 'promotionClick'>> }
      )>> }> }
  )> };
