...
export type QuoteSliderBannerQueryVariables = Types.Exact<{
...
export type QuoteSliderBannerQuery = { quoteSliderBanner: Types.Maybe<(
    Pick<Types.QuoteSliderBanner, 'internalTitle'>
    & { quoteItemCollection: Types.Maybe<{ items: Array<Types.Maybe<(
        Pick<Types.QuoteSliderItem, 'quoteTitleImage'>
        & { quote: Types.Maybe<Pick<Types.QuoteSliderItemQuote, 'json'>> }
      )>> }> }
  )> };


export const QuoteSliderBannerDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"quoteSliderBanner"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"locale"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"preview"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"quoteSliderBanner"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"locale"},"value":{"kind":"Variable","name":{"kind":"Name","value":"locale"}}},{"kind":"Argument","name":{"kind":"Name","value":"preview"},"value":{"kind":"Variable","name":{"kind":"Name","value":"preview"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"internalTitle"}},{"kind":"Field","name":{"kind":"Name","value":"quoteItemCollection"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"quote"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"json"}}]}},{"kind":"Field","name":{"kind":"Name","value":"quoteTitleImage"}}]}}]}}]}}]}}]} as unknown as DocumentNode;

export function useQuoteSliderBannerQuery(options: Omit<Urql.UseQueryArgs<QuoteSliderBannerQueryVariables>, 'query'>) {
  return Urql.useQuery<QuoteSliderBannerQuery, QuoteSliderBannerQueryVariables>({ query: QuoteSliderBannerDocument, ...options });
};
