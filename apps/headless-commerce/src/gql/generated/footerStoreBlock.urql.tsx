...
export type FooterStoreBlockQueryVariables = Types.Exact<{
...
export type FooterStoreBlockQuery = { footerStoreBlock: Types.Maybe<(
    Pick<Types.FooterStoreBlock, 'title' | 'description' | 'internalTitle'>
    & { cta: Types.Maybe<(
