...
export type UpdateSubscribeMutationVariables = Types.Exact<{
  updateSubscribeInput: Types.InputMaybe<Types.UpdateSubscribeInput>;
}>;


export type UpdateSubscribeMutation = { updateSubscribe: Pick<Types.SubscribeResponse, 'success' | 'email' | 'status'> };
