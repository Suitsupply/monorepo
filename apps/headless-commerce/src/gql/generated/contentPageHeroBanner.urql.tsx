...
export type ContentPageHeroBannerQueryVariables = Types.Exact<{
...
export type ContentPageHeroBannerQuery = { contentPageHeroBanner: Types.Maybe<(
    Pick<Types.ContentPageHeroBanner, 'viewHeightSetMobile' | 'colorPalette' | 'desktopTextAlignment' | 'tabletTextAlignment' | 'mobileTextAlignment' | 'sublineShowOnDesktop' | 'sublineShowOnMobile' | 'sublineShowOnTablet'>
    & { title: Types.Maybe<Pick<Types.ContentPageHeroBannerTitle, 'json'>>, image: Types.Maybe<(
      ...
      Pick<Types.ContentPageHeroBannerSubline, 'json'>
