...
export type FooterNewsletterBlockQueryVariables = Types.Exact<{
...
export type FooterNewsletterBlockQuery = { footerNewsletterBlock: Types.Maybe<(
    Pick<Types.FooterNewsletterBlock, 'title'>
