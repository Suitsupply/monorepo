import { COUNTRYSWITCH_ACTION_STAY } from '@headless-commerce/constants/cookie';
import { convertCookieFormatToLocale, convertLocaleToCookieFormat } from '@headless-commerce/utils/localeUtils';
