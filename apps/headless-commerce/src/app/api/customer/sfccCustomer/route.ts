...
import type { AllowedLocaleCountry } from '@headless-commerce/config/locale';
import { COUNTRY, LAST_VISITED_LOCALE } from '@headless-commerce/constants/cookie';
import { SUITSUPPLY_CLIENT_COUNTRY } from '@headless-commerce/constants/headers';
...
import { pathnameLocalePrefix } from '@headless-commerce/utils/pathname';
