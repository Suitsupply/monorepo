...
import FooterBottomBlock from '@headless-commerce/components/Footer/FooterBottomBlock/FooterBottomBlock';
import FooterContactAndLinksBlock from '@headless-commerce/components/Footer/FooterContactAndLinksBlock/FooterContactAndLinksBlock';
import FooterNewsletterBlock from '@headless-commerce/components/Footer/FooterNewsletterBlock/FooterNewsletterBlock';
import FooterStoreBlock from '@headless-commerce/components/Footer/FooterStoreBlock/FooterStoreBlock';
import FooterUspBlock from '@headless-commerce/components/Footer/FooterUspBlock/FooterUspBlock';
