import ClientTerms from '@headless-commerce/components/Footer/FooterBottomBlock/ClientTerms';
import ClientLocaleDisplay from '@headless-commerce/components/LocaleDisplay/ClientLocaleDisplay';
import type { Locale } from '@headless-commerce/config/locale';
import type {
  FooterBottomBlockQuery,
  FooterBottomBlockQueryVariables,
} from '@headless-commerce/gql/generated/footerBottomBlock.urql';
import type { Cta, LinkWithImage, SiteId, SocialLinksWrapper } from '@headless-commerce/gql/generated/graphql';
