import ImageTextCard from '@headless-commerce/components/ImageTextCard/ImageTextCard';
import type {
...
import type { CarouselImageAndTextCard } from '@headless-commerce/gql/generated/graphql';
