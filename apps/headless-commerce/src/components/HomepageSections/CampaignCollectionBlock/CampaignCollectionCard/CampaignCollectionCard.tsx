...
import type { ICampaignCollectionCard } from '@headless-commerce/components/HomepageSections/CampaignCollectionBlock/CampaignCollectionCard/CampaignCollectionCard.types';
