...
import type { ShirtOptionSelectProperties } from '@headless-commerce/libs/avo/avo';
...
export const trackShirtOptionSelectEvent = ({
  categoryStep,
  country,
  locale,
  pageType,
      ...
      segment: {
        ...
        properties: enrichEvent(
          ...
          },
          {
            ...
            locationId,
            pageType: pageType as ShirtOptionSelectProperties['pageType'],
            path,
