...
import type { TrousersOptionSelectProperties } from '@headless-commerce/libs/avo/avo';
...
export const trackTrousersOptionSelectEvent = ({
  categoryStep,
  country,
  locale,
  pageType,
      ...
      segment: {
        ...
        properties: enrichEvent(
          ...
          },
          {
            ...
            locationId,
            pageType: pageType as TrousersOptionSelectProperties['pageType'],
            path,
