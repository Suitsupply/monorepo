...
import type { BowtieOptionSelectProperties } from '@headless-commerce/libs/avo/avo';
...
export const trackBowtieOptionSelectEvent = ({
  categoryStep,
  country,
  locale,
  pageType,
      ...
      segment: {
        ...
        properties: enrichEvent(
          ...
          },
          {
            ...
            locationId,
            pageType: pageType as BowtieOptionSelectProperties['pageType'],
            path,
