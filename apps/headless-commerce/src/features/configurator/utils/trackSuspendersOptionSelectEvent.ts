...
import type { SuspendersOptionSelectProperties } from '@headless-commerce/libs/avo/avo';
...
export const trackSuspendersOptionSelectEvent = ({
  categoryStep,
  country,
  locale,
  pageType,
      ...
      segment: {
        ...
        properties: enrichEvent(
          ...
          },
          {
            ...
            locationId,
            pageType: pageType as SuspendersOptionSelectProperties['pageType'],
            path,
