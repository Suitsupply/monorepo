...
import type { FabricOptionSelectProperties } from '@headless-commerce/libs/avo/avo';
...
export const trackJacketOptionSelectEvent = ({
  categoryStep,
  country,
  locale,
  pageType,
      ...
      segment: {
        ...
        properties: enrichEvent(
          ...
          },
          {
            ...
            locationId,
            pageType: pageType as FabricOptionSelectProperties['pageType'],
            path,
