...
import type { AllowedLocaleCountry, AllowedLocaleLanguage, Locale } from '@headless-commerce/config/locale';
...
import { get } from '@headless-commerce/utils/configuration';
